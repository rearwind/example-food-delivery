...
기능적 요구사항
1. 고객이 메뉴를 선택하여 주문한다
1. 고객이 선택한 메뉴에 대해 결제한다. => 수정1 : 고객이 선택한 메뉴에 대해 결제하되, 결제가 되지 않으면 주문되지 않는다.
1. 주문이 되면 주문 내역이 입점상점주인에게 전달된다 => 수정2 : 주문이 되면 주문 내역이 입점상점주인에게 주문정보가 전달되고, 해당 음식(food)의 재고가 주문수량만큼 줄어든다.
1. 상점주는 주문을 수락하거나 거절할 수 있다
1. 상점주는 요리시작때와 완료 시점에 시스템에 상태를 입력한다
1. 고객은 아직 요리가 시작되지 않은 주문은 취소할 수 있다
1. 고객이 주문을 취소할 수 있다 => 수정3: 고객은 아직 요리가 시작되지 않은 주문은 취소할 수 있고, 해당 음식(food)의 재고가 주문수량만큼 늘어난다(원복된다).
